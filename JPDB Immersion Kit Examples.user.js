...
(function() {
    ...
    function getResponsiveImageWidth() {
        return `min(${CONFIG.IMAGE_WIDTH}, calc(100vw - 2rem))`;
    }

    function getArrowWidth() {
        return isNarrowScreen() ? '44px' : CONFIG.ARROW_WIDTH;
    }
    ...
    function createImageElement(wrapperDiv, imageUrl, vocab, exactSearch) {
        ...
        if (isIOS()) {
            ...
            const responsiveWidth = getResponsiveImageWidth();

            // --- Outer container ---
            const imgContainer = document.createElement('div');
            imgContainer.style = `width:${responsiveWidth};max-width:${width}px;margin:10px auto 0;position:relative;min-height:${height}px;`;
            ...
            return GM_addElement(wrapperDiv, 'img', {
                ...
                alt: 'Embedded Image',
                title: titleText,
                style: `width: 100%; max-width: ${getResponsiveImageWidth()}; margin-top: 10px; cursor: pointer; height: auto;`
        });
        }
    }
    ...
    function appendSentenceAndTranslation(wrapperDiv, sentence, translation) {
        ...
        sentenceText.style.maxWidth = getResponsiveImageWidth();
        ...
        if (CONFIG.ENABLE_EXAMPLE_TRANSLATION && translation) {
            ...
            translationText.style.maxWidth = getResponsiveImageWidth();
    ...
    function createNavigationDiv() {
        ...
        navigationDiv.style.maxWidth = getResponsiveImageWidth();
    ...
    function createLeftArrow(vocab, shouldAutoPlaySound) {
        ...
        leftArrow.style.width = getArrowWidth();
        leftArrow.style.minWidth = getArrowWidth();
    ...
    function createRightArrow(vocab, shouldAutoPlaySound) {
        ...
        rightArrow.style.width = getArrowWidth();
        rightArrow.style.minWidth = getArrowWidth();
    ...
    function createContainerDiv(leftArrow, wrapperDiv, rightArrow, navigationDiv) {
        ...
        containerDiv.style.maxWidth = getResponsiveImageWidth();
        ...
        arrowWrapperDiv.style.width = '100%';
        ...
        if (isNarrowScreen()) {
            ...
            leftArrow.style.marginRight = '0';
            rightArrow.style.marginLeft = '0';
            navigationDiv.style.flex = '1';

            arrowWrapperDiv.appendChild(wrapperDiv);
            controlsDiv.append(leftArrow, navigationDiv, rightArrow);
            containerDiv.append(arrowWrapperDiv, controlsDiv);
        } else {
    ...
    function appendContainer(containerDiv) {
        ...
        if (CONFIG.WIDE_MODE && !isNarrowScreen() && subsectionMeanings) {
    ...
    function setPageWidth() {
        ...
        document.body.style.maxWidth = isNarrowScreen() ? '100%' : CONFIG.PAGE_WIDTH;
    }
